  ...
  const handleLogout = async () => {
    ...
    try {
      const response = await axios({
        url: 'http://localhost:8888/api/v1/jwt/auth/logout',
        method: 'post',
        headers: {
                  ...
                  return (
                    <React.Fragment>
                      ...
                      >
                        ...
                        >
                          <path
                            d="M7 4V1H5V4H2L4 8V19C4 19.55 4.45 20 5 20H19C19.55 20 20 19.55 20 19V8L22 4H19V1H17V4H7Z"
                            fill=""
                          />
                          <path
                            d="M10 15C10 14.4477 10.4477 14 11 14C11.5523 14 12 14.4477 12 15C12 15.5523 11.5523 16 11 16C10.4477 16 10 15.5523 10 15Z"
                            fill=""
                          />
                          <path
                            d="M16 15C16 14.4477 16.4477 14 17 14C17.5523 14 18 14.4477 18 15C18 15.5523 17.5523 16 17 16C16.4477 16 16 15.5523 16 15Z"
                            fill=""
                          />
                        </svg>
                        Products
